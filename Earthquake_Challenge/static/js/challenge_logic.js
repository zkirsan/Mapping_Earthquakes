...
let overlays = {
  ...
  "Major Eartquakes": majorEarthquake
};
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function (data) {
  ...
  d3.json("https://raw.githubusercontent.com/zkirsan/Mapping_Earthquakes/main/PB2002_boundaries.json").then(function(data) {
    console.log(data);
  // Creating a GeoJSON layer with the retrieved data.
  L.geoJson(data, {
    style: myStyle
